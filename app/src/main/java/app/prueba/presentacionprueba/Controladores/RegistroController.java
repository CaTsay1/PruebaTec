...
import app.prueba.presentacionprueba.Models.Usuario;
import app.prueba.presentacionprueba.utils.ProgressDialogUtil;

public class RegistroController {    public static void registrarUsuario(String nombre, String correo, String contrasena,
